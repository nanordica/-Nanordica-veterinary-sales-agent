...
## Meditsiiniseadme reklaam

RavimusVET on **meditsiiniseade**. Seetõttu:
- Väited (nt "~2× kiirem paranemine") peavad olema **tõendatud** ja esitatud
  korrektselt, viitega kliinilisele uuringule.
- **Ära liialda** ega laienda väiteid üle selle, mida uuring katab.
- Väldi ravivlubadusi, mida tõend ei toeta.
- Vt `product-ravimus-vet.md` lubatud väidete loend.
